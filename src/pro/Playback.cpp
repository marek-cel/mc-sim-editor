...
{
    _time_start   = node->attribute("time_start").toDouble();
    _time_end     = node->attribute("time_end").toDouble();
    _speed        = node->attribute("speed").toDouble();
    _current_time = node->attribute("current_time").toDouble();
